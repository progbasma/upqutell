                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="primary_input mb-15">
                                        ...
                                        <div class="primary_file_uploader">
                                            <input class="primary-input courseLabel" type="text"
                                            ...
                                            <div class="multi_btn">
                                                <button class="" type="button">
                                                    ...
                                                    <input type="file" class="d-none courseLabel" name="photo"
                                                           id="document_file_1">
                                                </button>
                                ...
                                <div class="col-lg-6">
                                    <div class="primary_input mb-15">
                                        ...
                                        <div class="primary_file_uploader">
                                            <input class="primary-input courseLabel2" type="text"
                                                   id="placeholderFileOneName"
                                                   placeholder="Browse file" readonly="">
                                            <div class="multi_btn">
                                                <button class="" type="button">
                                                    ...
                                                    <input type="file" class="d-none courseLabel2"
