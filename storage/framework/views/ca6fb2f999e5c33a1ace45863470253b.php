    ...
    <section class="apk">
        <div class="container">
            ...
            <div class="row apk-skill">
                <div class="col-md-6">
                    <div class="apk-skill-card" style="--bg-image: url('<?php echo e(themeAsset('img/others/apk-card-1.png')); ?>')">
                ...
                <div class="col-md-6">
                    <div class="apk-skill-card" style="--bg-image: url('<?php echo e(themeAsset('img/others/apk-card-2.png')); ?>')">
                        <span>New Collection</span>
                        <h3>Level - Up Your Raw Coding <br> Skills in Lockdown</h3>
                        <a href="#" class="theme-btn">Find Out More</a>
                    </div>
...
<?php /**PATH D:\xampp\htdocs\github\upqutell\resources\views/frontend/infixlmstheme/snippets/components/_apk_section_v3.blade.php ENDPATH**/ ?>