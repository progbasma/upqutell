<div data-type="component-text"
     data-preview="<?php echo e(!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/shop/3.jpg')); ?>"
     data-aoraeditor-title="Shop Section Dark" data-aoraeditor-categories="Shop;Home Page">
    ...
    <div class="shop">
        <div class="shop-shape"><img src="<?php echo e(themeAsset('img/shape/shop.png')); ?>" alt=""></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-subtitle">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <div>
                                <h3 class="mb-0 text-white">Kids Edu Shop</h3>
                            </div>
                            <div class="section-subtitle-action mt-0">
                                <a href="#" class="theme-btn bg-white ms-2">All Products</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH D:\xampp\htdocs\github\upqutell\resources\views/frontend/infixlmstheme/snippets/components/_shop_section_v3.blade.php ENDPATH**/ ?>