...
>
    <style>
        ...
        .about-inner {
            background: rgba(0, 0, 0, 0.86) url(../img/shape/about-bg-shape.png) no-repeat center;
            padding: 80px 0px
        }
...
<?php /**PATH D:\xampp\htdocs\github\upqutell\resources\views/frontend/infixlmstheme/snippets/components/_home_sponsor_success.blade.php ENDPATH**/ ?>