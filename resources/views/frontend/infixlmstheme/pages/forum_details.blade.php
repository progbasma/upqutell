                                    ...
                                    @if ($forum->replies->count()>0)
                                        ...
                                        <div class="forum_replay" id="1">
                                            @foreach ($forum->replies as $key=> $reply)
                                                        ...
                                                        <div class="thumb">
                                                            <div
                                                                ...
                                                                <div class="studentProfileThumb"
                                                                     style="background-image: url('{{getProfileImage($reply->user->image)}}');margin: 0"></div>
                                                            </div>
                                                ...
                                                {{-- @dd($reply->repliesofReply) --}}
                                                {{-- Start Reply of reply --}}
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="thumb">
                                                                    <div
                                                                        class="profile_info profile_img collaps_icon d-flex align-items-center">
                                                                        <div class="studentProfileThumb"
                                                                             style="background-image: url('{{getProfileImage($second_reply->user->image)}}');margin: 0"></div>
                                                                    </div>
                                                                    <!-- user_hover_card ::start -->
                                                                    <div class="user_hover_card">
                                                                        <div class="user_card_top">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="thumb position-relative">
                                                                    <div
                                                                        class="profile_info profile_img collaps_icon d-flex align-items-center">
                                                                        <div class="studentProfileThumb"
                                                                             style="background-image: url('{{getProfileImage(Auth::user()->image)}}');margin: 0"></div>
                                                                    </div>
